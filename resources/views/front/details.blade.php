...
<img src="{{ $articleNews->author?->avatar ? route('private.file',$articleNews->author->avatar) : asset('default-avatar.png') }}" class="object-cover w-full h-full" alt="avatar">						</div>
...
<img src="{{ route('private.file',$articleNews->thumbnail) }}" class="object-cover w-full h-full" alt="cover thumbnail">		</div>
	</header>
...
<img src="{{ route('private.file', $bannerads->thumbnail) }}" class="object-cover w-full h-full" alt="ads" />    </a>
@else
...
<img src="{{ route('private.file', $bannerads->thumbnail) }}" class="object-cover w-full h-full" alt="ads" />				</div>
			</a>
			<p class="font-medium text-sm leading-[21px] text-[#A3A6AE] flex gap-1">
				Our Advertisement <a href="#" class="w-[18px] h-[18px]"><img
						src="{{ asset('assets/images/icons/message-question.svg') }} " alt="icon" /></a>
